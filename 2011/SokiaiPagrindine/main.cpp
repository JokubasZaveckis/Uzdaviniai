...
void Nuskaitymas(int& n, int&k, Sokejas sokejai[]);
int VisuBaluSkaiciavimas(int teisejuSkaicius, int taskai[]);
void MaziausiuBaluSkaiciavimas(int n, int k, Sokejas sokejai[]);
void DidziausiuBaluSkaiciavimas(int n, int k, Sokejas sokejai[]);
void GalutiniuPorosBaluSkaiciavimas(int n, int k, Sokejas sokejai[]);
...
int main()
{
    ...
    Nuskaitymas(n, k, sokejai);
    MaziausiuBaluSkaiciavimas(n, k, sokejai);
    DidziausiuBaluSkaiciavimas(n, k, sokejai);
    GalutiniuPorosBaluSkaiciavimas(n, k, sokejai);
...
void GalutiniuPorosBaluSkaiciavimas(int n, int k, Sokejas sokejai[])
{
    for(int i=0; i<n; i++)
    {
        ...
        int b = VisuBaluSkaiciavimas(k, sokejai[i].artistiskumoBalai);
